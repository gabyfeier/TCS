...
# Load project
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -G/top/test/NR_OF_TRANSACTION=$2 -G/top/test/RANDOM=$3 -G/top/test/seed=$4 -G/top/test/testname=$5 top
